...
continue_btn.onclick = () => {
    ...
    startTimer(15); //call ing startTimer function
...
quit_quiz.onclick = () => {
    window.location.href = "/jogo expotec/jogo/jogo.html";//reload the current window
...
function showResult() {
    ...
    if (userScore > 4) {
        ...
        let scoreTag = '<span> Desculpa, so teve <p>' + userScore + '</p> de <p>' + questions.length + '</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
